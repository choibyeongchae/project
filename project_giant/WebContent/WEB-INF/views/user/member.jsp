...
<form class="signUp" id="signupForm" method="post" action="/user/loginPost">
   <h1 class="signUpTitle">Sign up in seconds</h1>
   <input type="text" class="signUpInput" placeholder="Type your username" name="id">
   <input type="password" class="signUpInput" placeholder="Choose a password" name="password">
