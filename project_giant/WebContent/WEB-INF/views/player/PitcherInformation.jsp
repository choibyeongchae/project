...
.align_text {
					...
					<div class="player_wrap">
					    <div class="top">
					        ...
					        <c:forEach items="${list }" var="pitcherVO" begin="0" end="0">
					            <img src="${pitcherVO.img}" alt="">
					        </div>
					        <div class="right_content">
					            <div class="player_position">
					                <h4>${pitcherVO.position }</h4>
					            </div>
					            <div class="en_name">
					            <p>${pitcherVO.name}</p>
                                </div>
  ...
  <tr>
    <th>生年月日</th>
    <th>${pitcherVO.birth }</th>
  </tr>
  <tr>
    <td>投打</td>
    <td>${pitcherVO.pitcherhitting }</td>
  </tr>
                               <tr>
                                   <td>身長/体重</td>
                                   <td>${pitcherVO.height }cm/${pitcherVO.weight}kg</td>
                               </tr>
                               <tr>
                                   <td>経歴</td>
                                   <td>${pitcherVO.career }</td>
                               </tr>
                               <tr>
                                   <td>入団年度</td>
                                   <td>${fn:substring(pitcherVO.enteryear,0,4) }년</td>
                               </tr>
                               </c:forEach>
                                </table>
                                </div>
