				...
				<div class="box-footer">
					...
					<div class="text-center">
							<ul class="pagination">
								...
								<li><a
									href="secondPlayer${pageMaker.makeSearch(pageMaker.startPage - 1) }">&laquo;</a></li>
								</c:if>
								...
								<c:forEach begin="${pageMaker.startPage }"
									...
									<li
										...
										<a href="secondPlayer${pageMaker.makeSearch(idx)}">${idx}</a>
									</li>
								</c:forEach>
	
								<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
									<li><a
										href="secondPlayer${pageMaker.makeSearch(pageMaker.endPage +1) }">&raquo;</a></li>
								</c:if>
