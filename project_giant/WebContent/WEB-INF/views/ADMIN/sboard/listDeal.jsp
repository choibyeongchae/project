				...
				<div class="box-body">
					...
					<c:forEach items="${list}" var="boardVO" begin="0">
						...
						<tr>
							...
							<a href='../sboard/listDealRead${pageMaker.makeSearch(pageMaker.cri.page) }&writenum=${boardVO.writenum}'>
				...
				<div class="box-footer">
					...
					<div class="text-center">
							<ul class="pagination">
								...
								<li><a
									href="listDeal${pageMaker.makeSearch(pageMaker.startPage - 1) }">&laquo;</a></li>
								</c:if>
								...
								<c:forEach begin="${pageMaker.startPage }"
									...
									<li
										...
										<a href="listDeal${pageMaker.makeSearch(idx)}">${idx}</a>
									</li>
								</c:forEach>
	
								<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
									<li><a
										href="listDeal${pageMaker.makeSearch(pageMaker.endPage +1) }">&raquo;</a></li>
								</c:if>
