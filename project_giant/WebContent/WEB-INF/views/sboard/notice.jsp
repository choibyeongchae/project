				...
				<section class="carousel">
				   <script type="text/javascript"
                        src="http://pagead2.googlesyndication.com/pagead/show_ads.js">
                                ...
                                <table id="table" style="width: 650px" class="table table-striped">
                                  ...
                                  <c:forEach items="${list}" var="boardVO">
                                  	...
                                  	<tr>
                                  		...
                                  		<td><a href='noticeboard_detail${pageMaker.makeSearch(pageMaker.cri.page) }&writenum=${boardVO.writenum}'>
							${boardVO.writetitle}
							</a>
							...
							<ul class="pagination">
								 <li> <a href="notice${pageMaker.makeSearch(startPage)}">First </a> </li> 
								 <c:if test="${pageMaker.prev}">
								<li><a
									href="notice${pageMaker.makeSearch(pageMaker.startPage - 1) }">&laquo;</a></li>
								</c:if>
								...
								<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
									<li><a
										href="notice${pageMaker.makeSearch(pageMaker.endPage +1) }">&raquo;</a></li>
								</c:if>
								 <li> <a href="notice?page=${pageMaker.tempEndPage }">Last </a> </li> 
							</ul>
						</div>
