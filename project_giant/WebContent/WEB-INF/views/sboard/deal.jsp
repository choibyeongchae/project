						...
						<nav id="nav">
							<ul>
								...
								<li><a href="../team/teamRank?year=2017">記録室</a>
								    <ul>
								        <li><a href="../team/teamRank?2017">チーム順位</a></li>
				...
				<section class="carousel">
				   <script type="text/javascript"
                        src="http://pagead2.googlesyndication.com/pagead/show_ads.js">
                                ...
                                <table id="table" style="width: 650px" class="table table-striped">
                                  ...
                                  <c:forEach items="${list}" var="boardVO">
                                  	...
                                  	<tr>
                                  		...
                                  		<td><a href='deal_detail${pageMaker.makeSearch(pageMaker.cri.page) }&writenum=${boardVO.writenum}'>
							...
							<ul class="pagination">
								 <li> <a href="deal${pageMaker.makeSearch(startPage)}">First </a> </li> 
								 <c:if test="${pageMaker.prev}">
								<li><a
									href="deal${pageMaker.makeSearch(pageMaker.startPage - 1) }">&laquo;</a></li>
								</c:if>
								...
								<c:forEach begin="${pageMaker.startPage }"
									...
									<li
										...
										<a href="deal${pageMaker.makeSearch(idx)}">${idx}</a>
									</li>
								</c:forEach>
	
								<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
									<li><a
										href="deal${pageMaker.makeSearch(pageMaker.endPage +1) }">&raquo;</a></li>
								</c:if>
								 <li> <a href="deal?page=${pageMaker.tempEndPage }">Last </a> </li> 
							</ul>
						</div>
