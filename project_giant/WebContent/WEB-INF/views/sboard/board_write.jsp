...
-->
                               <div id="table" style="width: 900px;" class="table table-striped">
                                       <div class="form-group">
                                           ...
                                           <input type="text" name="writetitle" class="form_control" placeholder="enter title">
                                       </div>
                                       <div class="form-group">
                                           <label for="exam">Content</label>
                                           <textarea class="form-control" name="writecontent" rows="3" placeholder="Enter..."></textarea>
                                       </div>
                                       <div class="form-group">
                                           <label for="exam">Writer</label>
                                           <input type="text" name="writepeople" class="form_control" value="${login.id}" readonly >
                                       </div>
                               </div>
                               <br>
