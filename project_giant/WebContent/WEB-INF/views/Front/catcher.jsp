		...
		<div id="page-wrapper">
			...
			<!-- Banner -->
				...
				<select class="select_list" onchange="move_to_Page(this.value)">
				    ...
				    <option value="catcher" selected>捕手</option>
				</select>
		...
		<div id="portfolio-content" class="center-text">
			<div class="portfolio-page" id="page-1">
				<div class="portfolio-group">
					<a class="portfolio-item" href="../player/playerInformation?backnum=44">
						<img src="../resources/images/kangdongkwan.PNG" alt="image 1">
				...
				<div class="portfolio-group">
					<a class="portfolio-item" href="../player/playerInformation?backnum=127">
						<img src="../resources/images/koseongwoo.PNG" alt="image 3">
						<div class="detail">
				...
				<div class="portfolio-group">
					<a class="portfolio-item" href="../player/playerInformation?backnum=13">
						<img src="../resources/images/kimsahun.PNG" alt="image 4">
						<div class="detail">
				...
				<div class="portfolio-group">
					<a class="portfolio-item" href="../player/playerInformation?backnum=30">
						<img src="../resources/images/kimhojun.PNG" alt="image 5">
						<div class="detail">
				...
				<div class="portfolio-group">
					<a class="portfolio-item" href="../player/playerInformation?backnum=39">
						<img src="../resources/images/najongdeok.PNG" alt="image 7">
						<div class="detail">
				...
				<div class="portfolio-group">
					<a class="portfolio-item" href="../player/playerInformation?backnum=29">
					<img src="../resources/images/ahnjoongyeol.PNG" alt="image 7">
						<div class="detail">
				...
				<div class="portfolio-group">
					<a class="portfolio-item" href="Front/playerInformation">
